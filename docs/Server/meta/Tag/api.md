...
<h1 id="metadata-service-api-tag">Tag</h1>

## post__api_ConstTag_{projname}_{nodename}

> Code samples

```http
POST /api/ConstTag/{projname}/{nodename} HTTP/1.1

Accept: application/json

```

`POST /api/ConstTag/{projname}/{nodename}`

*Get downloaded constant tags for a node*

Retrieves constant tags for the specified project and node

<h3 id="post__api_consttag_{projname}_{nodename}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projname|path|string|true|Project Name|
|nodename|path|string|true|Node Name|
...
<h3 id="post__api_consttag_{projname}_{nodename}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Constant Tags result|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_Tag_{projname}_{nodename}_{devicename}

> Code samples

```http
POST /api/Tag/{projname}/{nodename}/{devicename} HTTP/1.1

Accept: application/json

```

`POST /api/Tag/{projname}/{nodename}/{devicename}`

*Get downloaded tags for a device*

Retrieves tags for the specified project, node, and device

<h3 id="post__api_tag_{projname}_{nodename}_{devicename}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projname|path|string|true|Project Name|
|nodename|path|string|true|Node Name|
|devicename|path|string|true|Device Name|
...
<h3 id="post__api_tag_{projname}_{nodename}_{devicename}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Tags result|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_TagPage_{projname}

> Code samples

```http
POST /api/TagPage/{projname} HTTP/1.1
...
`POST /api/TagPage/{projname}`

*Get downloaded tag page for a project*

Retrieves paginated tags for the specified project
...
<h3 id="post__api_tagpage_{projname}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projname|path|string|true|Project Name|
|body|body|object|true|Pagination or filter data|
...
<h3 id="post__api_tagpage_{projname}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Paginated tags result|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
