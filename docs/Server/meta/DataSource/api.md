...
<h1 id="metadata-service-api-datasource">DataSource</h1>

## post__api_DataSource_delete_{sourcetype}

> Code samples

```http
POST /api/DataSource/delete/{sourcetype} HTTP/1.1

Accept: application/json

```

`POST /api/DataSource/delete/{sourcetype}`

*Delete DataSource*

Delete DataSource by source type

<h3 id="post__api_datasource_delete_{sourcetype}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|sourcetype|path|integer|true|Source Type|
...
<h3 id="post__api_datasource_delete_{sourcetype}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad Request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_DataSource_getMQTTBrokerSetting

> Code samples

```http
POST /api/DataSource/getMQTTBrokerSetting HTTP/1.1
...
`POST /api/DataSource/getMQTTBrokerSetting`

*Get MQTT Broker Setting*

Login and get MQTT broker setting
...
<h3 id="post__api_datasource_getmqttbrokersetting-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|Login info|
...
<h3 id="post__api_datasource_getmqttbrokersetting-responses">Responses</h3>
...
## post__api_DataSource_insert

> Code samples

```http
POST /api/DataSource/insert HTTP/1.1
...
<h3 id="post__api_datasource_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataSourceHead](#schemamodel.datasourcehead)|true|DataSource payload|
...
<h3 id="post__api_datasource_insert-responses">Responses</h3>
...
## post__api_DataSource_query_{sourcetype}

> Code samples

```http
POST /api/DataSource/query/{sourcetype} HTTP/1.1

Accept: application/json

```

`POST /api/DataSource/query/{sourcetype}`

*Query DataSource*

Query DataSource by source type

<h3 id="post__api_datasource_query_{sourcetype}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|sourcetype|path|integer|true|Source Type (0~3)|
...
<h3 id="post__api_datasource_query_{sourcetype}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-array_model_DataSource](#schemamodel.baseresponse-array_model_datasource)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad Request|[model.BaseResponse-array_model_DataSource](#schemamodel.baseresponse-array_model_datasource)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_DataSource_querybody_{sourcetype}

> Code samples

```http
POST /api/DataSource/querybody/{sourcetype} HTTP/1.1

Accept: application/json

```

`POST /api/DataSource/querybody/{sourcetype}`

*Query DataSource Body*

Query DataSource Body by source type

<h3 id="post__api_datasource_querybody_{sourcetype}-parameters">Parameters</h3>
...
<h3 id="post__api_datasource_querybody_{sourcetype}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-array_model_DataSourceBody](#schemamodel.baseresponse-array_model_datasourcebody)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad Request|[model.BaseResponse-array_model_DataSourceBody](#schemamodel.baseresponse-array_model_datasourcebody)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_DataSource_querybodykey_{sourcetype}

> Code samples

```http
POST /api/DataSource/querybodykey/{sourcetype} HTTP/1.1

Accept: application/json

```

`POST /api/DataSource/querybodykey/{sourcetype}`

*Query DataSource Body Key*

Query DataSource key-value or config info

<h3 id="post__api_datasource_querybodykey_{sourcetype}-parameters">Parameters</h3>
...
<h3 id="post__api_datasource_querybodykey_{sourcetype}-responses">Responses</h3>
...
## post__api_DataSource_queryboth_{sourcetype}

> Code samples

```http
POST /api/DataSource/queryboth/{sourcetype} HTTP/1.1

Accept: application/json

```

`POST /api/DataSource/queryboth/{sourcetype}`

*Query DataSource both*

Query DataSource head and body

<h3 id="post__api_datasource_queryboth_{sourcetype}-parameters">Parameters</h3>
...
<h3 id="post__api_datasource_queryboth_{sourcetype}-responses">Responses</h3>
...
## post__api_DataSource_update

> Code samples

```http
POST /api/DataSource/update HTTP/1.1
...
<h3 id="post__api_datasource_update-parameters">Parameters</h3>
...
<h3 id="post__api_datasource_update-responses">Responses</h3>
...
## post__api_setting_DataSource_queryboth_{sourcetype}

> Code samples

```http
POST /api/setting/DataSource/queryboth/{sourcetype} HTTP/1.1

Accept: application/json

```

`POST /api/setting/DataSource/queryboth/{sourcetype}`

*Query DataSource both*

Query DataSource head and body

<h3 id="post__api_setting_datasource_queryboth_{sourcetype}-parameters">Parameters</h3>
...
<h3 id="post__api_setting_datasource_queryboth_{sourcetype}-responses">Responses</h3>
...
## post__api_setting_DataSource_update

> Code samples

```http
POST /api/setting/DataSource/update HTTP/1.1
...
`POST /api/setting/DataSource/update`
...
<h3 id="post__api_setting_datasource_update-parameters">Parameters</h3>
...
<h3 id="post__api_setting_datasource_update-responses">Responses</h3>
