...
<h1 id="metadata-service-api-opcua-tags">OPCUA-Tags</h1>

## post__api_opcua_nodetag_{projid}

> Code samples

```http
POST /api/opcua/nodetag/{projid} HTTP/1.1
...
`POST /api/opcua/nodetag/{projid}`

*Browse node tags*

Browse child tags of a node from server
...
<h3 id="post__api_opcua_nodetag_{projid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|body|body|[model.TagPath](#schemamodel.tagpath)|true|Connection name and NodeID|
...
<h3 id="post__api_opcua_nodetag_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Node tags list|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to browse node tags|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_projtaglist_{projid}

> Code samples

```http
POST /api/opcua/projtaglist/{projid} HTTP/1.1
...
`POST /api/opcua/projtaglist/{projid}`

*List tags for a project*

Get a list of tags in the project (from database or server)
...
<h3 id="post__api_opcua_projtaglist_{projid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|body|body|[model.TagListFilter](#schemamodel.taglistfilter)|true|Tag filter options|
...
<h3 id="post__api_opcua_projtaglist_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of tags|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to get tags|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_roottag_{projid}

> Code samples

```http
POST /api/opcua/roottag/{projid} HTTP/1.1
...
`POST /api/opcua/roottag/{projid}`

*Browse root tags*

Browse root tags from server for a project
...
<h3 id="post__api_opcua_roottag_{projid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|body|body|[model.TagPath](#schemamodel.tagpath)|true|Connection name|
...
<h3 id="post__api_opcua_roottag_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Root tags list|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to browse root tags|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_tag_delete

> Code samples

```http
POST /api/opcua/tag/delete HTTP/1.1
...
`POST /api/opcua/tag/delete`

*Delete tags*

Delete one or more tags from the database
...
<h3 id="post__api_opcua_tag_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.TagDelete](#schemamodel.tagdelete)|true|Tags to delete|
...
<h3 id="post__api_opcua_tag_delete-responses">Responses</h3>
...
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to delete tags|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_tag_detail

> Code samples

```http
POST /api/opcua/tag/detail HTTP/1.1
...
`POST /api/opcua/tag/detail`

*Get tag detail*

Get detail of a specific tag
...
<h3 id="post__api_opcua_tag_detail-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.TagDetail](#schemamodel.tagdetail)|true|Tag info|
...
<h3 id="post__api_opcua_tag_detail-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Tag detail|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to get tag detail|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_tag_insert

> Code samples

```http
POST /api/opcua/tag/insert HTTP/1.1
...
<h3 id="post__api_opcua_tag_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.TagMultiInsert](#schemamodel.tagmultiinsert)|true|Tags to insert|
...
<h3 id="post__api_opcua_tag_insert-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Insert success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to insert tags|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_tag_update

> Code samples

```http
POST /api/opcua/tag/update HTTP/1.1
...
<h3 id="post__api_opcua_tag_update-parameters">Parameters</h3>
...
<h3 id="post__api_opcua_tag_update-responses">Responses</h3>
...
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to update tag|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_taglist_{projid}

> Code samples

```http
POST /api/opcua/taglist/{projid} HTTP/1.1
...
`POST /api/opcua/taglist/{projid}`

*List tags for a project (by connection)*

Get a list of tags in the project filtered by connection
...
<h3 id="post__api_opcua_taglist_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_opcua_taglist_{projid}-responses">Responses</h3>
...
## post__api_opcua_tagpage_{projid}

> Code samples

```http
POST /api/opcua/tagpage/{projid} HTTP/1.1
...
`POST /api/opcua/tagpage/{projid}`

*Get paginated tag list*

Get a page of tags with total count
...
<h3 id="post__api_opcua_tagpage_{projid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|body|body|[model.TagPage](#schemamodel.tagpage)|true|Pagination and filter options|
...
<h3 id="post__api_opcua_tagpage_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Paginated tags|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to get tag page|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_setting_opcua_const_delete

> Code samples

```http
POST /api/setting/opcua/const/delete HTTP/1.1
...
`POST /api/setting/opcua/const/delete`

*Delete constant tags*

Delete one or more constant tags
...
<h3 id="post__api_setting_opcua_const_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.TagDelete](#schemamodel.tagdelete)|true|Constant tags to delete|
...
<h3 id="post__api_setting_opcua_const_delete-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Delete success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to delete constant tags|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_setting_opcua_const_list_{projid}

> Code samples

```http
POST /api/setting/opcua/const/list/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/setting/opcua/const/list/{projid}`

*List constant tags*

List all constant tags for a project

<h3 id="post__api_setting_opcua_const_list_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_setting_opcua_const_list_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Constant tags list|[model.BaseResponse-array_model_ConstDetail](#schemamodel.baseresponse-array_model_constdetail)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to list constant tags|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_setting_opcua_const_upsert

> Code samples

```http
POST /api/setting/opcua/const/upsert HTTP/1.1
...
`POST /api/setting/opcua/const/upsert`

*Upsert a constant tag*

Insert or update a constant tag
...
<h3 id="post__api_setting_opcua_const_upsert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.ConstUpdate](#schemamodel.constupdate)|true|Constant tag info|
...
<h3 id="post__api_setting_opcua_const_upsert-responses">Responses</h3>
...
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to upsert constant tag|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_setting_opcua_tagconfig_{projid}

> Code samples

```http
POST /api/setting/opcua/tagconfig/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/setting/opcua/tagconfig/{projid}`

*Get tag configuration*

Get configuration for tags of a project

<h3 id="post__api_setting_opcua_tagconfig_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_setting_opcua_tagconfig_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Tag configuration|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to get tag configuration|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
