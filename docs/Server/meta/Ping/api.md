...
<h1 id="metadata-service-api-ping">Ping</h1>
...
Responds with a pong message and logs the provided ID

<h3 id="post__ping_{id}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|id|path|string|true|ID to log|
...
<h3 id="post__ping_{id}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Returns pong message|[controller.Pong](#schemacontroller.pong)|
