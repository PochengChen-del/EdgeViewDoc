...
<h1 id="metadata-service-api-recipe">Recipe</h1>

## post__api_recipe_change

> Code samples

```http
POST /api/recipe/change HTTP/1.1
...
`POST /api/recipe/change`

*Change recipe*

Apply changes to a recipe based on given change instructions
...
<h3 id="post__api_recipe_change-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecipeChange](#schemamodel.recipechange)|true|Recipe change information|
...
<h3 id="post__api_recipe_change-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Change result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_recipe_delete

> Code samples

```http
POST /api/recipe/delete HTTP/1.1
...
Deletes one or more recipes specified by project ID and recipe name
...
<h3 id="post__api_recipe_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecipeDelete](#schemamodel.recipedelete)|true|List of recipes to delete|
...
<h3 id="post__api_recipe_delete-responses">Responses</h3>
...
## post__api_recipe_detail

> Code samples

```http
POST /api/recipe/detail HTTP/1.1
...
Retrieve detailed information of a recipe by project ID and recipe name
...
<h3 id="post__api_recipe_detail-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecipeID](#schemamodel.recipeid)|true|Project ID and Recipe Name|
...
<h3 id="post__api_recipe_detail-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Recipe detail|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid input|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_recipe_list_{projid}

> Code samples

```http
POST /api/recipe/list/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/recipe/list/{projid}`

*Get recipe list*

Retrieve list of recipes for a given project

<h3 id="post__api_recipe_list_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_recipe_list_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of recipes|[model.BaseResponse-array_model_RecipeListStruct](#schemamodel.baseresponse-array_model_recipeliststruct)|
...
## post__api_recipe_upsert

> Code samples

```http
POST /api/recipe/upsert HTTP/1.1
...
`POST /api/recipe/upsert`

*Create or update recipe*

Inserts a new recipe or updates an existing one. Checks for duplicate names if necessary.
...
<h3 id="post__api_recipe_upsert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecipeStruct](#schemamodel.recipestruct)|true|Recipe information to upsert|
...
<h3 id="post__api_recipe_upsert-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Upsert result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid input or duplicate recipe|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
