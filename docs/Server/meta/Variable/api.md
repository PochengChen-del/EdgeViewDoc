...
<h1 id="metadata-service-api-variable">Variable</h1>

## post__api_variable_change

> Code samples

```http
POST /api/variable/change HTTP/1.1
...
`POST /api/variable/change`

*Exchange variable order*

Change the order of variables in a project/display
...
<h3 id="post__api_variable_change-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.VariableExchange](#schemamodel.variableexchange)|true|Variable exchange data|
...
<h3 id="post__api_variable_change-responses">Responses</h3>
...
## post__api_variable_default_{projid}

> Code samples

```http
POST /api/variable/default/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/variable/default/{projid}`

*Reset project variables to default*

Reset all variables in a project to default values

<h3 id="post__api_variable_default_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_variable_default_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Reset result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_variable_delete

> Code samples

```http
POST /api/variable/delete HTTP/1.1
...
Remove one or multiple variables from project/display
...
<h3 id="post__api_variable_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.VariableDelete](#schemamodel.variabledelete)|true|Variables to delete|
...
<h3 id="post__api_variable_delete-responses">Responses</h3>
...
## post__api_variable_export

> Code samples

```http
POST /api/variable/export HTTP/1.1
...
<h3 id="post__api_variable_export-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.VariableDelete](#schemamodel.variabledelete)|true|Variables to export|
...
<h3 id="post__api_variable_export-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Exported JSON file|string|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid parameters|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_variable_import

> Code samples

```http
POST /api/variable/import HTTP/1.1
...
`POST /api/variable/import`

*Import variables*

Import multiple variables into a project/display
...
<h3 id="post__api_variable_import-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.VariImport](#schemamodel.variimport)|true|Variables to import|
...
<h3 id="post__api_variable_import-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Import result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid data|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_variable_insert

> Code samples

```http
POST /api/variable/insert HTTP/1.1
...
`POST /api/variable/insert`

*Insert a variable*

Add a new variable to the project/display
...
<h3 id="post__api_variable_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.VariableStruct](#schemamodel.variablestruct)|true|Variable data|
...
<h3 id="post__api_variable_insert-responses">Responses</h3>
...
## post__api_variable_list_{projid}

> Code samples

```http
POST /api/variable/list/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/variable/list/{projid}`

*List global variables*

Get all global variables in a project

<h3 id="post__api_variable_list_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_variable_list_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of global variables|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid Project ID|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_variable_list_{projid}_{displayid}

> Code samples

```http
POST /api/variable/list/{projid}/{displayid} HTTP/1.1

Accept: application/json

```

`POST /api/variable/list/{projid}/{displayid}`

*List variables for a display*

Get all variables in a project for a specific display

<h3 id="post__api_variable_list_{projid}_{displayid}-parameters">Parameters</h3>
...
<h3 id="post__api_variable_list_{projid}_{displayid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of variables|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid parameters|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_variable_update

> Code samples

```http
POST /api/variable/update HTTP/1.1
...
<h3 id="post__api_variable_update-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.VariableUpdate](#schemamodel.variableupdate)|true|Variable update data|
...
<h3 id="post__api_variable_update-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid parameters or variable name exists|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
