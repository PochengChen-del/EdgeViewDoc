...
<h1 id="metadata-service-api-group">Group</h1>

## post__api_group_delete

> Code samples

```http
POST /api/group/delete HTTP/1.1
...
<h3 id="post__api_group_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.GroupDetail](#schemamodel.groupdetail)|true|群組刪除條件|
...
<h3 id="post__api_group_delete-responses">Responses</h3>
...
## post__api_group_detail

> Code samples

```http
POST /api/group/detail HTTP/1.1
...
<h3 id="post__api_group_detail-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.GroupDetail](#schemamodel.groupdetail)|true|群組查詢條件|
...
<h3 id="post__api_group_detail-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|成功|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|參數錯誤|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_group_insert

> Code samples

```http
POST /api/group/insert HTTP/1.1
...
<h3 id="post__api_group_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|projid, type, name|
...
<h3 id="post__api_group_insert-responses">Responses</h3>
...
## post__api_group_list

> Code samples

```http
POST /api/group/list HTTP/1.1
...
<h3 id="post__api_group_list-parameters">Parameters</h3>
...
<h3 id="post__api_group_list-responses">Responses</h3>
...
## post__api_group_update

> Code samples

```http
POST /api/group/update HTTP/1.1
...
<h3 id="post__api_group_update-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|projid, type, id, 其他欄位|
...
<h3 id="post__api_group_update-responses">Responses</h3>
