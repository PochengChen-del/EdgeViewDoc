...
<h1 id="metadata-service-api-alarm">Alarm</h1>

## post__api_alarm_allinfo_{projid}

> Code samples

```http
POST /api/alarm/allinfo/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/alarm/allinfo/{projid}`

*Get all alarm info*

Get complete alarm info and details for a project

<h3 id="post__api_alarm_allinfo_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_alarm_allinfo_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|All alarm info|[model.BaseResponse-model_AlarmAllInfo](#schemamodel.baseresponse-model_alarmallinfo)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID|[model.BaseResponse-model_AlarmAllInfo](#schemamodel.baseresponse-model_alarmallinfo)|
...
## post__api_alarm_delete

> Code samples

```http
POST /api/alarm/delete HTTP/1.1
...
<h3 id="post__api_alarm_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.AlarmDelete](#schemamodel.alarmdelete)|true|Alarms to delete|
...
<h3 id="post__api_alarm_delete-responses">Responses</h3>
...
## post__api_alarm_detail

> Code samples

```http
POST /api/alarm/detail HTTP/1.1
...
<h3 id="post__api_alarm_detail-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.AlarmID](#schemamodel.alarmid)|true|Alarm identifier|
...
<h3 id="post__api_alarm_detail-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Alarm detail|[model.BaseResponse-model_AlarmDetail](#schemamodel.baseresponse-model_alarmdetail)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_alarm_info_{projid}

> Code samples

```http
POST /api/alarm/info/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/alarm/info/{projid}`

*Get alarm info*

Get basic alarm info by project ID

<h3 id="post__api_alarm_info_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_alarm_info_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Alarm info result|[model.BaseResponse-model_AlarmStructDetail](#schemamodel.baseresponse-model_alarmstructdetail)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID|[model.BaseResponse-model_AlarmStructDetail](#schemamodel.baseresponse-model_alarmstructdetail)|
...
## post__api_alarm_list_{projid}

> Code samples

```http
POST /api/alarm/list/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/alarm/list/{projid}`

*Get alarm list*

Get list of alarms for a project

<h3 id="post__api_alarm_list_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_alarm_list_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Alarm list|[model.BaseResponse-array_model_AlarmArea](#schemamodel.baseresponse-array_model_alarmarea)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID|[model.BaseResponse-array_model_AlarmArea](#schemamodel.baseresponse-array_model_alarmarea)|
...
## post__api_alarm_updateinfo

> Code samples

```http
POST /api/alarm/updateinfo HTTP/1.1
...
`POST /api/alarm/updateinfo`

*Update alarm info*

Update alarm configuration information
...
<h3 id="post__api_alarm_updateinfo-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.AlarmStruct](#schemamodel.alarmstruct)|true|Alarm info|
...
<h3 id="post__api_alarm_updateinfo-responses">Responses</h3>
...
## post__api_alarm_upsert

> Code samples

```http
POST /api/alarm/upsert HTTP/1.1
...
<h3 id="post__api_alarm_upsert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.AlarmUpsertStruct](#schemamodel.alarmupsertstruct)|true|Alarm upsert data|
...
<h3 id="post__api_alarm_upsert-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|409|[Conflict](https://tools.ietf.org/html/rfc7231#section-6.5.8)|Duplicate alarm|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
