...
<h1 id="metadata-service-api-project">Project</h1>
...
Retrieves organization list under current root organization
...
<h3 id="post__api_orglist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Organization list|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_project_default_{projid}

> Code samples

```http
POST /api/project/default/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/project/default/{projid}`

*Initialize default project resources*

Sets up default assets (audio, image, model, drawio) and database entries for a project

<h3 id="post__api_project_default_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_project_default_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Initialization result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_project_detail_{projid}

> Code samples

```http
POST /api/project/detail/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/project/detail/{projid}`

*Get project details*

Retrieves detailed information about a project

<h3 id="post__api_project_detail_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_project_detail_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Project details|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
Update project information with given details
...
<h3 id="post__api_project_update-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[WxMetaService_model_device.ProjectDetail](#schemawxmetaservice_model_device.projectdetail)|true|Project details to update|
...
<h3 id="post__api_project_update-responses">Responses</h3>
...
## post__api_tenantlist

> Code samples

```http
POST /api/tenantlist HTTP/1.1
...
Retrieves tenants the current user has access to
...
<h3 id="post__api_tenantlist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of tenants|[model.BaseResponse-array_model_Tenant](#schemamodel.baseresponse-array_model_tenant)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_userprojlist

> Code samples

```http
POST /api/userprojlist HTTP/1.1

Accept: application/json

```

`POST /api/userprojlist`

*Get list of projects for the current user*

Retrieves projects the logged-in user has access to
...
<h3 id="post__api_userprojlist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of user projects|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
