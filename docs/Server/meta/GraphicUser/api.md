...
<h1 id="metadata-service-api-graphicuser">GraphicUser</h1>

## post__api_opcua_graphic_user_detail

> Code samples

```http
POST /api/opcua/graphic/user/detail HTTP/1.1
...
`POST /api/opcua/graphic/user/detail`

*Get graphic user detail*

Returns detail info for a specific graphic user in a project
...
<h3 id="post__api_opcua_graphic_user_detail-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.GUserProj](#schemamodel.guserproj)|true|Graphic user request|
...
<h3 id="post__api_opcua_graphic_user_detail-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Graphic user detail|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_opcua_graphic_user_existinginsert

> Code samples

```http
POST /api/opcua/graphic/user/existinginsert HTTP/1.1
...
`POST /api/opcua/graphic/user/existinginsert`

*Insert existing graphic users into project*

Add graphic users that already exist to the project
...
<h3 id="post__api_opcua_graphic_user_existinginsert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.GUserProjList](#schemamodel.guserprojlist)|true|List of graphic users to insert|
...
<h3 id="post__api_opcua_graphic_user_existinginsert-responses">Responses</h3>
...
## post__api_opcua_graphic_user_existinguserlist_{projid}

> Code samples

```http
POST /api/opcua/graphic/user/existinguserlist/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/opcua/graphic/user/existinguserlist/{projid}`

*Get graphic users not in this project*

Returns graphic users that are not part of the given project

<h3 id="post__api_opcua_graphic_user_existinguserlist_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_opcua_graphic_user_existinguserlist_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of users not in project|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_opcua_graphic_user_firstpwdupdate

> Code samples

```http
POST /api/opcua/graphic/user/firstpwdupdate HTTP/1.1
...
`POST /api/opcua/graphic/user/firstpwdupdate`

*Update graphic user password*

Update password for current graphic user
...
<h3 id="post__api_opcua_graphic_user_firstpwdupdate-parameters">Parameters</h3>
...
<h3 id="post__api_opcua_graphic_user_firstpwdupdate-responses">Responses</h3>
...
## post__api_opcua_graphic_user_insert

> Code samples

```http
POST /api/opcua/graphic/user/insert HTTP/1.1
...
`POST /api/opcua/graphic/user/insert`

*Insert new graphic user*

Add a new graphic user to the project
...
<h3 id="post__api_opcua_graphic_user_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.GUserProj](#schemamodel.guserproj)|true|Graphic user info|
...
<h3 id="post__api_opcua_graphic_user_insert-responses">Responses</h3>
...
## post__api_opcua_graphic_user_remove

> Code samples

```http
POST /api/opcua/graphic/user/remove HTTP/1.1
...
`POST /api/opcua/graphic/user/remove`

*Remove graphic users*

Remove one or more graphic users by ID list
...
<h3 id="post__api_opcua_graphic_user_remove-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.GUserIDList](#schemamodel.guseridlist)|true|List of graphic user IDs|
...
<h3 id="post__api_opcua_graphic_user_remove-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Remove success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid input|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_opcua_graphic_user_update

> Code samples

```http
POST /api/opcua/graphic/user/update HTTP/1.1
...
`POST /api/opcua/graphic/user/update`

*Update graphic user*

Update graphic user info
...
<h3 id="post__api_opcua_graphic_user_update-parameters">Parameters</h3>
...
<h3 id="post__api_opcua_graphic_user_update-responses">Responses</h3>
...
## post__api_opcua_graphic_userlist_{projid}

> Code samples

```http
POST /api/opcua/graphic/userlist/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/opcua/graphic/userlist/{projid}`

*Get graphic user list for a project*

Returns all graphic users under the given project

<h3 id="post__api_opcua_graphic_userlist_{projid}-parameters">Parameters</h3>
  ...
  "result": [
    {
      ...
      "enable": true,
      "id": 1,
      "modifytime": "2026/01/22 09:30:00",
      "name": "UserA",
      "usertype": 0
    }
  ]
...
<h3 id="post__api_opcua_graphic_userlist_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of graphic users|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
