...
<h1 id="metadata-service-api-objectpath">ObjectPath</h1>
...
<h3 id="post__api_addfolder-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.AddFolderReq](#schemamodel.addfolderreq)|true|Folder info|
...
<h3 id="post__api_addfolder-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-model_AddFolderRes](#schemamodel.baseresponse-model_addfolderres)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|with error code and reason|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_copyobject

> Code samples

```http
POST /api/copyobject HTTP/1.1
...
*Copy an object to a target path*

Copy an object like Display, JS, Image, Audio, or DataModel to a new folder or path
...
<h3 id="post__api_copyobject-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.MoveObjectReq](#schemamodel.moveobjectreq)|true|Copy Object Request|
...
<h3 id="post__api_copyobject-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-array_model_CopyObject](#schemamodel.baseresponse-array_model_copyobject)|
...
## post__api_deletefolder

> Code samples

```http
POST /api/deletefolder HTTP/1.1
...
<h3 id="post__api_deletefolder-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DeleteFolderReq](#schemamodel.deletefolderreq)|true|Folder IDs|
...
<h3 id="post__api_deletefolder-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|with error code and reason|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_deletepath

> Code samples

```http
POST /api/deletepath HTTP/1.1
...
*Delete a path and all its child objects*

Delete a folder or object path including its children like Display, JS, Image, Audio, DataModel, Template
...
<h3 id="post__api_deletepath-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.AddFolderRes](#schemamodel.addfolderres)|true|Delete Path Request|
...
<h3 id="post__api_deletepath-responses">Responses</h3>
...
*Export project objects*

Export project objects, including Displays, JS, Images, DataModels, Audios, Templates, Variables, Records, and PluginFiles
...
<h3 id="post__api_export-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.ObjectExport](#schemamodel.objectexport)|true|Export Object Request|
...
<h3 id="post__api_export-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Encrypted project export file|string|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid input|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_getfolderid_{projid}_{action}

> Code samples

```http
POST /api/getfolderid/{projid}/{action} HTTP/1.1

Accept: application/json

```

`POST /api/getfolderid/{projid}/{action}`

*Get folder path ID by full path text*

Returns the ID of a folder path based on the full path text under a project

<h3 id="post__api_getfolderid_{projid}_{action}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|action|path|string|true|Full path text (optional)|
...
<h3 id="post__api_getfolderid_{projid}_{action}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Path ID|[model.BaseResponse-int](#schemamodel.baseresponse-int)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID or path|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_getnextlevelbyid_{pathid}_{type}

> Code samples

```http
POST /api/getnextlevelbyid/{pathid}/{type} HTTP/1.1

Accept: application/json

```

`POST /api/getnextlevelbyid/{pathid}/{type}`

*Get next level objects by path ID*

根據 pathID 及 type 取得下一層的物件列表

<h3 id="post__api_getnextlevelbyid_{pathid}_{type}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|pathid|path|integer|true|Path ID|
|type|path|integer|true|Object type|
...
<h3 id="post__api_getnextlevelbyid_{pathid}_{type}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-model_GetNextLevelbyidRes](#schemamodel.baseresponse-model_getnextlevelbyidres)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|with error code and reason|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_getnextlevelpath_{pathid}

> Code samples

```http
POST /api/getnextlevelpath/{pathid} HTTP/1.1
...
`POST /api/getnextlevelpath/{pathid}`

*Get next level paths under a path*

Returns the child objects under the given path ID with an optional limit
...
<h3 id="post__api_getnextlevelpath_{pathid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|pathid|path|integer|true|Parent Path ID|
|body|body|[model.QuerySearchUnderPath](#schemamodel.querysearchunderpath)|true|Query options, e.g., Limit|
...
<h3 id="post__api_getnextlevelpath_{pathid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of next level paths|[model.BaseResponse-array_model_NextLevelObj](#schemamodel.baseresponse-array_model_nextlevelobj)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid path ID or request body|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
Import project objects from encrypted export file
...
<h3 id="post__api_import-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|none|
|» projid|body|integer|true|Project ID|
|» importpw|body|string|true|Import Password|
|» duplicate|body|string|false|Duplicate handling: ignore, cover, newfile|
|» files|body|string(binary)|true|Exported project file|
...
<h3 id="post__api_import-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of imported objects|Inline|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid input|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<h3 id="post__api_import-responseschema">Response Schema</h3>

Status Code **200**

|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|*anonymous*|[[model.CopyObject1](#schemamodel.copyobject1)]|false|none|none|
...
## post__api_moveobject

> Code samples

```http
POST /api/moveobject HTTP/1.1
...
*Move an object to a target path*

Move an object like Display, JS, Image, Audio, or DataModel to a new folder or path
...
<h3 id="post__api_moveobject-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.MoveObjectReq](#schemamodel.moveobjectreq)|true|Move Object Request|
...
<h3 id="post__api_moveobject-responses">Responses</h3>
...
## post__api_pathdetail_{pathid}

> Code samples

```http
POST /api/pathdetail/{pathid} HTTP/1.1

Accept: application/json

```

`POST /api/pathdetail/{pathid}`

*Get path detail*

根據 pathID 取得該路徑的詳細資訊

<h3 id="post__api_pathdetail_{pathid}-parameters">Parameters</h3>
...
<h3 id="post__api_pathdetail_{pathid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-model_NextLevelObj](#schemamodel.baseresponse-model_nextlevelobj)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|with error code and reason|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
<h3 id="post__api_rename-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.ReNameReq](#schemamodel.renamereq)|true|Rename info|
...
<h3 id="post__api_rename-responses">Responses</h3>
...
## post__api_searchunderpath_{pathid}

> Code samples

```http
POST /api/searchunderpath/{pathid} HTTP/1.1
...
`POST /api/searchunderpath/{pathid}`

*Search objects under a path*

Search for objects under the specified path ID with filter and limit
...
<h3 id="post__api_searchunderpath_{pathid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|pathid|path|integer|true|Parent Path ID|
|body|body|[model.QuerySearchUnderPath](#schemamodel.querysearchunderpath)|true|Search filters, limit, etc.|
...
<h3 id="post__api_searchunderpath_{pathid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of matching objects under the path|[model.BaseResponse-array_model_NextLevelObj](#schemamodel.baseresponse-array_model_nextlevelobj)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid path ID or request body|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
