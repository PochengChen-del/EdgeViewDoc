...
<h1 id="metadata-service-api-display">Display</h1>

## post__api_createdisplay

> Code samples

```http
POST /api/createdisplay HTTP/1.1
...
`POST /api/createdisplay`

*Create or update a display*

Create a new display or update an existing one
...
<h3 id="post__api_createdisplay-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|none|
|» id|body|integer|true|Display ID (0 for new)|
|» projid|body|integer|true|Project ID|
|» name|body|string|true|Display name|
|» content|body|string|false|Content|
|» phonecontent|body|string|false|Phone content|
|» tabletcontent|body|string|false|Tablet content|
|» parentpathid|body|integer|true|Parent path ID|
|» files|body|string(binary)|false|Thumbnail file|
|» phonefiles|body|string(binary)|false|Phone file|
|» tabletfiles|body|string(binary)|false|Tablet file|
...
<h3 id="post__api_createdisplay-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-model_CreateDisplayRes](#schemamodel.baseresponse-model_createdisplayres)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_deletedisplay

> Code samples

```http
POST /api/deletedisplay HTTP/1.1
...
`POST /api/deletedisplay`

*Delete displays*

Delete one or multiple displays by IDs
...
<h3 id="post__api_deletedisplay-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DeleteDisplayReq](#schemamodel.deletedisplayreq)|true|Delete display request|
...
<h3 id="post__api_deletedisplay-responses">Responses</h3>
...
*Get display and datamodel list*

Retrieve display and datamodel list by file IDs
...
<h3 id="post__api_disdmlist-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.FileIDsReq](#schemamodel.fileidsreq)|true|File IDs request|
...
<h3 id="post__api_disdmlist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-array_model_FileStruct](#schemamodel.baseresponse-array_model_filestruct)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_getdisplaydetail_{displayid}

> Code samples

```http
POST /api/getdisplaydetail/{displayid} HTTP/1.1

Accept: application/json

```

`POST /api/getdisplaydetail/{displayid}`

*Get display detail*

Retrieve display detail by display ID

<h3 id="post__api_getdisplaydetail_{displayid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|displayid|path|string|true|Display ID|
...
<h3 id="post__api_getdisplaydetail_{displayid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-model_DisplayDetailMobileVer](#schemamodel.baseresponse-model_displaydetailmobilever)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_getdisplaydetail_{displayid}_{type}

> Code samples

```http
POST /api/getdisplaydetail/{displayid}/{type} HTTP/1.1

Accept: application/json

```

`POST /api/getdisplaydetail/{displayid}/{type}`

*Get mobile display detail*

Retrieve display detail for mobile by display ID and type

<h3 id="post__api_getdisplaydetail_{displayid}_{type}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|displayid|path|string|true|Display ID|
|type|path|string|true|Mobile type (phone/tablet)|
...
<h3 id="post__api_getdisplaydetail_{displayid}_{type}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-model_DisplayDetail](#schemamodel.baseresponse-model_displaydetail)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_getdisplayid_{projid}_{action}

> Code samples

```http
POST /api/getdisplayid/{projid}/{action} HTTP/1.1

Accept: application/json

```

`POST /api/getdisplayid/{projid}/{action}`

*Get display ID by project and path*

Retrieve display ID from project ID and action path

<h3 id="post__api_getdisplayid_{projid}_{action}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|action|path|string|true|Action path|
...
<h3 id="post__api_getdisplayid_{projid}_{action}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-int](#schemamodel.baseresponse-int)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_getdisplaylist_{projid}

> Code samples

```http
POST /api/getdisplaylist/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/getdisplaylist/{projid}`

*Get display list by project*

Retrieve all displays for a given project ID

<h3 id="post__api_getdisplaylist_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_getdisplaylist_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-array_model_Display](#schemamodel.baseresponse-array_model_display)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_getdisplayversion_{displayid}

> Code samples

```http
POST /api/getdisplayversion/{displayid} HTTP/1.1

Accept: application/json

```

`POST /api/getdisplayversion/{displayid}`

*Get display version*

Retrieve version info for a display by ID

<h3 id="post__api_getdisplayversion_{displayid}-parameters">Parameters</h3>
...
<h3 id="post__api_getdisplayversion_{displayid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-model_DisplayVersionRes](#schemamodel.baseresponse-model_displayversionres)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_getdisplayversionlist_{projid}

> Code samples

```http
POST /api/getdisplayversionlist/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/getdisplayversionlist/{projid}`

*Get display version list*

Retrieve all display versions for a project

<h3 id="post__api_getdisplayversionlist_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_getdisplayversionlist_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-map_int_model_DisplayVersionInfo](#schemamodel.baseresponse-map_int_model_displayversioninfo)|
