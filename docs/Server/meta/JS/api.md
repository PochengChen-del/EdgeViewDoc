...
<h1 id="metadata-service-api-js">JS</h1>

## post__api_containjslist

> Code samples

```http
POST /api/containjslist HTTP/1.1
...
`POST /api/containjslist`

*檢查 JS 是否包含於指定 Path*

根據 PathID 與 JSIDs 返回包含的 JS 列表
...
<h3 id="post__api_containjslist-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.ContainJS](#schemamodel.containjs)|true|PathID 與 JSIDs|
...
<h3 id="post__api_containjslist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|成功|[model.BaseResponse-array_model_JSPathList](#schemamodel.baseresponse-array_model_jspathlist)|
...
## post__api_createjs_{parentpathid}

> Code samples

```http
POST /api/createjs/{parentpathid} HTTP/1.1
...
`POST /api/createjs/{parentpathid}`

*新增或更新 JS*

根據 parentpathid 創建或更新 JS 腳本
...
<h3 id="post__api_createjs_{parentpathid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|parentpathid|path|integer|true|Parent Path ID|
|body|body|[model.CreateJSReq](#schemamodel.createjsreq)|true|JS 內容與名稱|
...
<h3 id="post__api_createjs_{parentpathid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|成功|[model.BaseResponse-model_CreateJSRes](#schemamodel.baseresponse-model_createjsres)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|參數錯誤|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
<h3 id="post__api_deletejs-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DeleteJSReq](#schemamodel.deletejsreq)|true|要刪除的 JS ID 列表|
...
<h3 id="post__api_deletejs-responses">Responses</h3>
...
## post__api_getjsbypathtext

> Code samples

```http
POST /api/getjsbypathtext HTTP/1.1
...
`POST /api/getjsbypathtext`

*根據 PathText 取得 JS*

根據 pathtext 與 projid 返回 JS 詳細資訊
...
<h3 id="post__api_getjsbypathtext-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|projid 與 pathtext|
...
<h3 id="post__api_getjsbypathtext-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|成功|[model.BaseResponse-model_JSDetailRes](#schemamodel.baseresponse-model_jsdetailres)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|參數錯誤|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_getjsdetail_{jsid}

> Code samples

```http
POST /api/getjsdetail/{jsid} HTTP/1.1

Accept: application/json

```

`POST /api/getjsdetail/{jsid}`

*取得 JS 詳細內容*

根據 jsid 取得 JS 詳細資訊

<h3 id="post__api_getjsdetail_{jsid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|jsid|path|integer|true|JS ID|
...
<h3 id="post__api_getjsdetail_{jsid}-responses">Responses</h3>
...
## post__api_getjslist_{displayid}

> Code samples

```http
POST /api/getjslist/{displayid} HTTP/1.1

Accept: application/json

```

`POST /api/getjslist/{displayid}`

*取得 Display 下的 JS 列表*

根據 displayid 取得對應的 JS 列表

<h3 id="post__api_getjslist_{displayid}-parameters">Parameters</h3>
...
<h3 id="post__api_getjslist_{displayid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|成功|[model.BaseResponse-array_model_JSListObject](#schemamodel.baseresponse-array_model_jslistobject)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|參數錯誤|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_getjsversionlist

> Code samples

```http
POST /api/getjsversionlist HTTP/1.1
...
<h3 id="post__api_getjsversionlist-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DeleteJSReq](#schemamodel.deletejsreq)|true|JS ID 列表|
...
<h3 id="post__api_getjsversionlist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|成功|[model.BaseResponse-array_model_JSVersionObj](#schemamodel.baseresponse-array_model_jsversionobj)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|參數錯誤|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_getjsversionlistbyproj_{projid}

> Code samples

```http
POST /api/getjsversionlistbyproj/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/getjsversionlistbyproj/{projid}`

*取得專案下 JS 版本列表*

根據 projectid 取得該專案 JS 版本資訊

<h3 id="post__api_getjsversionlistbyproj_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_getjsversionlistbyproj_{projid}-responses">Responses</h3>
...
## post__api_getprojectjslist_{projectid}

> Code samples

```http
POST /api/getprojectjslist/{projectid} HTTP/1.1

Accept: application/json

```

`POST /api/getprojectjslist/{projectid}`

*取得專案下 JS 列表*

根據 projectid 取得 JS 列表

<h3 id="post__api_getprojectjslist_{projectid}-parameters">Parameters</h3>
...
<h3 id="post__api_getprojectjslist_{projectid}-responses">Responses</h3>
