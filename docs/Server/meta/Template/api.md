...
<h1 id="metadata-service-api-template">Template</h1>

## post__api_template_delete

> Code samples

```http
POST /api/template/delete HTTP/1.1
...
<h3 id="post__api_template_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[controller.TemplateDeleteReq](#schemacontroller.templatedeletereq)|true|Template IDs to delete|
...
<h3 id="post__api_template_delete-responses">Responses</h3>
...
## post__api_template_detail_{tmpid}

> Code samples

```http
POST /api/template/detail/{tmpid} HTTP/1.1

Accept: application/json

```

`POST /api/template/detail/{tmpid}`

*Get template detail*

Retrieve details of a specific template by ID

<h3 id="post__api_template_detail_{tmpid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|tmpid|path|integer|true|Template ID|
...
<h3 id="post__api_template_detail_{tmpid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Template details|[model.BaseResponse-model_TemplateDetail](#schemamodel.baseresponse-model_templatedetail)|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|Template not found|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_template_list_{projid}

> Code samples

```http
POST /api/template/list/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/template/list/{projid}`

*List templates of a project*

Get all templates under the specified project

<h3 id="post__api_template_list_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_template_list_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of templates|[model.BaseResponse-array_model_TemplateIDName](#schemamodel.baseresponse-array_model_templateidname)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_template_upsert

> Code samples

```http
POST /api/template/upsert HTTP/1.1
...
`POST /api/template/upsert`

*Create or update a template*

Insert a new template or update an existing template
...
<h3 id="post__api_template_upsert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|Template data (id, parentpathid, projid, name, content)|

> Example responses

> Upsert result including ID, version, name, pathid
...
<h3 id="post__api_template_upsert-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Upsert result including ID, version, name, pathid|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid parameters|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|Template not found|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_template_version_{tmpid}

> Code samples

```http
POST /api/template/version/{tmpid} HTTP/1.1

Accept: application/json

```

`POST /api/template/version/{tmpid}`

*Get template version*

Retrieve the version of a specific template

<h3 id="post__api_template_version_{tmpid}-parameters">Parameters</h3>
...
<h3 id="post__api_template_version_{tmpid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Template version info|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_template_versionlist_{projid}

> Code samples

```http
POST /api/template/versionlist/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/template/versionlist/{projid}`

*List all template versions in a project*

Get all template versions for a project

<h3 id="post__api_template_versionlist_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_template_versionlist_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of template versions|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
