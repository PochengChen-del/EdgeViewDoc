...
<h1 id="metadata-service-api-login">Login</h1>
...
Return production info of the application
...
<h3 id="post__api_about-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Application info|[model.BaseResponse-service_ProductInfo](#schemamodel.baseresponse-service_productinfo)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_bi_checkToken

> Code samples

```http
POST /api/bi/checkToken HTTP/1.1

Accept: application/json

```

`POST /api/bi/checkToken`

*Check BI token*

Check validity of BI token
...
<h3 id="post__api_bi_checktoken-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|BI token info|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_bi_refreshToken

> Code samples

```http
POST /api/bi/refreshToken HTTP/1.1

Accept: application/json

```

`POST /api/bi/refreshToken`

*Refresh BI token*

Refresh BI authentication token
...
<h3 id="post__api_bi_refreshtoken-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Token refreshed|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad request|string|
...
|---|---|---|---|---|
|body|body|[WxMetaService_model_device.User](#schemawxmetaservice_model_device.user)|true|User login info|
...
|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Login success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
|401|[Unauthorized](https://tools.ietf.org/html/rfc7235#section-3.1)|Unauthorized|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
Logout and clear session for graphic client
...
|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Logout success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_setting_logout

> Code samples

```http
POST /api/setting/logout HTTP/1.1

Accept: application/json

```

`POST /api/setting/logout`

*User logout from setting*

Logout and clear session for setting client
...
<h3 id="post__api_setting_logout-responses">Responses</h3>
...
Return current datasource type (WebAccess, BI, Opcua, X)
...
<h3 id="post__api_source-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Datasource type|[model.BaseResponse-string](#schemamodel.baseresponse-string)|
...
Return system memory usage and datasource timing
...
<h3 id="post__api_sysstatus-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|System status info|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_usersecurity_{projectname}

> Code samples

```http
POST /api/usersecurity/{projectname} HTTP/1.1

Accept: application/json

```

`POST /api/usersecurity/{projectname}`

*Get user security info*

Return user security details for a project

<h3 id="post__api_usersecurity_{projectname}-parameters">Parameters</h3>
...
{
  "error": -501,
  "reason": "ErrorReasonFromServer",
  "result": false
}
```

<h3 id="post__api_usersecurity_{projectname}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|User security info|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|401|[Unauthorized](https://tools.ietf.org/html/rfc7235#section-3.1)|Unauthorized|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
Validate CSRF or BI token and return user info
...
<h3 id="post__api_validatetoken-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|User info with token|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|401|[Unauthorized](https://tools.ietf.org/html/rfc7235#section-3.1)|Unauthorized|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
