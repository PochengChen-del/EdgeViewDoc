...
<h1 id="metadata-service-api-mqttbroker">MQTTBroker</h1>

## post__api_getmqttbrokersetting

> Code samples

```http
POST /api/getmqttbrokersetting HTTP/1.1

Accept: application/json

```

`POST /api/getmqttbrokersetting`

*取得 MQTT Broker 設定*

取得系統中目前的 MQTT Broker 設定資訊
...
<h3 id="post__api_getmqttbrokersetting-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|成功|[model.BaseResponse-model_MQTTBrokerSetting](#schemamodel.baseresponse-model_mqttbrokersetting)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|參數錯誤或其他錯誤|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_updatemqttbrokersetting

> Code samples

```http
POST /api/updatemqttbrokersetting HTTP/1.1
...
`POST /api/updatemqttbrokersetting`

*更新 MQTT Broker 設定*

根據傳入 JSON 更新 MQTT Broker 設定
...
<h3 id="post__api_updatemqttbrokersetting-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|MQTT Broker 設定參數|
...
<h3 id="post__api_updatemqttbrokersetting-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|成功與否|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|參數錯誤或其他錯誤|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
