...
<h1 id="metadata-service-api-record">Record</h1>

## post__api_getrecordid_{projid}_{recordname}

> Code samples

```http
POST /api/getrecordid/{projid}/{recordname} HTTP/1.1

Accept: application/json

```

`POST /api/getrecordid/{projid}/{recordname}`

*Get record ID by name*

Retrieve a record ID using project ID and record name

<h3 id="post__api_getrecordid_{projid}_{recordname}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|recordname|path|string|true|Record Name|
...
<h3 id="post__api_getrecordid_{projid}_{recordname}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Record ID|[model.BaseResponse-int64](#schemamodel.baseresponse-int64)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID or record not found|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
Delete one or more records by IDs
...
<h3 id="post__api_record_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecordDelete](#schemamodel.recorddelete)|true|List of record IDs|
...
<h3 id="post__api_record_delete-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Delete result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_record_detail_{recordid}

> Code samples

```http
POST /api/record/detail/{recordid} HTTP/1.1

Accept: application/json

```

`POST /api/record/detail/{recordid}`

*Get record detail*

Retrieve detailed info of a record by record ID

<h3 id="post__api_record_detail_{recordid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|recordid|path|integer|true|Record ID|
...
<h3 id="post__api_record_detail_{recordid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Record detail|[model.BaseResponse-model_RecordStruct](#schemamodel.baseresponse-model_recordstruct)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid record ID|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_record_insert

> Code samples

```http
POST /api/record/insert HTTP/1.1
...
<h3 id="post__api_record_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecordStruct](#schemamodel.recordstruct)|true|Record data|
...
<h3 id="post__api_record_insert-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Insert result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid input or record exists|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_record_list_{projid}

> Code samples

```http
POST /api/record/list/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/record/list/{projid}`

*Get record list*

Retrieve list of records for a given project

<h3 id="post__api_record_list_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_record_list_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of records|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_record_search_{projid}

> Code samples

```http
POST /api/record/search/{projid} HTTP/1.1
...
`POST /api/record/search/{projid}`

*Search records*

Search records by name and additional filters for a project
...
<h3 id="post__api_record_search_{projid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|body|body|[controller.RecordSearchQuery](#schemacontroller.recordsearchquery)|true|Search query|
...
<h3 id="post__api_record_search_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Search results with total count|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID or input|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_record_update

> Code samples

```http
POST /api/record/update HTTP/1.1
...
<h3 id="post__api_record_update-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecordStruct](#schemamodel.recordstruct)|true|Record data to update|
...
<h3 id="post__api_record_update-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Update result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid input or record exists|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_record_updateenable

> Code samples

```http
POST /api/record/updateenable HTTP/1.1
...
`POST /api/record/updateenable`

*Enable or disable record*

Update record enable status
...
<h3 id="post__api_record_updateenable-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecordStruct](#schemamodel.recordstruct)|true|Record enable info|
...
<h3 id="post__api_record_updateenable-responses">Responses</h3>
...
## post__api_record_updateinfo

> Code samples

```http
POST /api/record/updateinfo HTTP/1.1
...
`POST /api/record/updateinfo`

*Update record info*

Update the detailed info/content of a record
...
<h3 id="post__api_record_updateinfo-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecordStruct](#schemamodel.recordstruct)|true|Record info data|
...
<h3 id="post__api_record_updateinfo-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Update result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid input or record not exist|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
