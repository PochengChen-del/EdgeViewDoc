...
<h1 id="metadata-service-api-opcua">OPCUA</h1>

## post__api_opcua_connect_delete

> Code samples

```http
POST /api/opcua/connect/delete HTTP/1.1
...
<h3 id="post__api_opcua_connect_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.ConnectionDelete](#schemamodel.connectiondelete)|true|Connection Info|
...
<h3 id="post__api_opcua_connect_delete-responses">Responses</h3>
...
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to delete connection|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_connect_detail

> Code samples

```http
POST /api/opcua/connect/detail HTTP/1.1
...
`POST /api/opcua/connect/detail`

*OPC UA Connection Detail*

Get detailed information for a specific OPC UA connection
...
<h3 id="post__api_opcua_connect_detail-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.ConnectionBase](#schemamodel.connectionbase)|true|Connection Info|
...
<h3 id="post__api_opcua_connect_detail-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Connection detail|[model.BaseResponse-model_ConnectionDetail](#schemamodel.baseresponse-model_connectiondetail)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to get connection detail|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_connect_insert

> Code samples

```http
POST /api/opcua/connect/insert HTTP/1.1
...
`POST /api/opcua/connect/insert`

*Insert OPC UA Connection*

Add a new OPC UA connection (supports multipart form for certificates)
...
<h3 id="post__api_opcua_connect_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|none|
|» projid|body|integer|true|Project ID|
|» name|body|string|true|Connection Name|
|» opcuri|body|string|true|OPC UA URI|
|» ApplicationName|body|string|false|Application Name for certificate|
|» DomainName|body|string|false|Domain Name for certificate|
|» DomainIP|body|string|false|Domain IP for certificate|
|» csrfToken|body|string|false|CSRF Token|
|» file|body|string(binary)|false|Certificate file|
...
<h3 id="post__api_opcua_connect_insert-responses">Responses</h3>
...
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to insert connection|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_connect_update

> Code samples

```http
POST /api/opcua/connect/update HTTP/1.1
...
`POST /api/opcua/connect/update`

*Update OPC UA Connection*

Update an existing OPC UA connection (supports multipart form for certificates)
...
<h3 id="post__api_opcua_connect_update-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|none|
|» projid|body|integer|true|Project ID|
|» oriname|body|string|true|Original Connection Name|
|» name|body|string|true|Connection Name|
|» opcuri|body|string|true|OPC UA URI|
|» ApplicationName|body|string|false|Application Name for certificate|
|» DomainName|body|string|false|Domain Name for certificate|
...
<h3 id="post__api_opcua_connect_update-responses">Responses</h3>
...
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to update connection|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_connectlist_{projid}

> Code samples

```http
POST /api/opcua/connectlist/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/opcua/connectlist/{projid}`

*List OPC UA Connections*

Get list of OPC UA connections for a project

<h3 id="post__api_opcua_connectlist_{projid}-parameters">Parameters</h3>
...
```json
{
  ...
  "result": [
    {
      "createtimestamp": "2026/01/23 08:00:00",
      "info": {
        "Item1": "Value1",
        "Item2": "Value2"
      },
      "modifytimestamp": "2026/01/23 12:00:00",
      "name": "ConnA",
      "opcuri": "opc.tcp://serverA:4840"
    }
  ]
}
```
...
<h3 id="post__api_opcua_connectlist_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of connections|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to query connections|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_proj_delete

> Code samples

```http
POST /api/opcua/proj/delete HTTP/1.1
...
`POST /api/opcua/proj/delete`

*Delete Projects*

Delete one or more OPC UA projects
...
<h3 id="post__api_opcua_proj_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.ProjIDList](#schemamodel.projidlist)|true|List of project IDs to delete|
...
<h3 id="post__api_opcua_proj_delete-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Delete success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to delete projects|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_proj_detail_{projid}

> Code samples

```http
POST /api/opcua/proj/detail/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/opcua/proj/detail/{projid}`

*Project Detail*

Get detailed information for a specific project

<h3 id="post__api_opcua_proj_detail_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_opcua_proj_detail_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Project detail|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to get project detail|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_proj_insert

> Code samples

```http
POST /api/opcua/proj/insert HTTP/1.1
...
`POST /api/opcua/proj/insert`

*Insert Project*

Add a new OPC UA project
...
<h3 id="post__api_opcua_proj_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[WxMetaService_model_opcua.ProjectDetail](#schemawxmetaservice_model_opcua.projectdetail)|true|Project information|

> Example responses

> Insert success, returns projid
...
<h3 id="post__api_opcua_proj_insert-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Insert success, returns projid|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to insert project|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_proj_update

> Code samples

```http
POST /api/opcua/proj/update HTTP/1.1
...
`POST /api/opcua/proj/update`

*Update Project*

Update an existing OPC UA project
...
<h3 id="post__api_opcua_proj_update-parameters">Parameters</h3>
...
<h3 id="post__api_opcua_proj_update-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Update success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to update project|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_opcua_projectlist

> Code samples

```http
POST /api/opcua/projectlist HTTP/1.1

Accept: application/json

```

`POST /api/opcua/projectlist`

*List OPC UA Projects*

Get the list of OPC UA projects for the current user
...
<h3 id="post__api_opcua_projectlist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of projects|[model.BaseResponse-array_WxMetaService_model_opcua_ProjectDetail](#schemamodel.baseresponse-array_wxmetaservice_model_opcua_projectdetail)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to query projects|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_setting_opcua_downloadcert_{projid}

> Code samples

```http
POST /api/setting/opcua/downloadcert/{projid} HTTP/1.1
...
`POST /api/setting/opcua/downloadcert/{projid}`

*Download OPC UA Certificate*

Download the PFX certificate bundle for a connection
...
<h3 id="post__api_setting_opcua_downloadcert_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_setting_opcua_downloadcert_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|PFX certificate ZIP|string|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to download certificate|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
