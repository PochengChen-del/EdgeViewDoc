...
<h1 id="metadata-service-api-webplugin">WebPlugin</h1>

## post__api_webpluginlist

> Code samples

```http
POST /api/webpluginlist HTTP/1.1

Accept: application/json

```

`POST /api/webpluginlist`

*List Web Plugins*

Get the list of available web plugins (excluding "ui")
...
<h3 id="post__api_webpluginlist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of plugin names|[model.BaseResponse-array_string](#schemamodel.baseresponse-array_string)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to read plugin directory|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_webpluginmetas

> Code samples

```http
POST /api/webpluginmetas HTTP/1.1

Accept: application/json

```

`POST /api/webpluginmetas`

*List Web Plugin Metas*

Get metadata (meta.json) of all available web plugins (excluding "ui")
...
<h3 id="post__api_webpluginmetas-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Map of plugin name to meta.json content|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to read plugin directory or meta.json|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
