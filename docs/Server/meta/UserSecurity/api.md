...
<h1 id="metadata-service-api-usersecurity">UserSecurity</h1>

## post__api_userscy_delete

> Code samples

```http
POST /api/userscy/delete HTTP/1.1
...
`POST /api/userscy/delete`

*Delete a security user*

Remove a security user
...
<h3 id="post__api_userscy_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.SecurityDetail](#schemamodel.securitydetail)|true|Security user to delete|
...
<h3 id="post__api_userscy_delete-responses">Responses</h3>
...
## post__api_userscy_insert

> Code samples

```http
POST /api/userscy/insert HTTP/1.1
...
`POST /api/userscy/insert`

*Insert a security user*
...
<h3 id="post__api_userscy_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.SecurityDetail](#schemamodel.securitydetail)|true|Security user detail|

> Example responses

> Inserted security user ID
...
<h3 id="post__api_userscy_insert-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Inserted security user ID|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid parameters|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_userscy_list_{projid}

> Code samples

```http
POST /api/userscy/list/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/userscy/list/{projid}`

*List security users*

Retrieve security user list for a project

<h3 id="post__api_userscy_list_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_userscy_list_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Security user list|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_userscy_update

> Code samples

```http
POST /api/userscy/update HTTP/1.1
...
`POST /api/userscy/update`

*Update a security user*

Modify an existing security user's data
...
<h3 id="post__api_userscy_update-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.SecurityDetail](#schemamodel.securitydetail)|true|Security user update details|
...
<h3 id="post__api_userscy_update-responses">Responses</h3>
