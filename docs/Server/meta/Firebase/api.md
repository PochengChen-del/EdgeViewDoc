...
<h1 id="metadata-service-api-firebase">Firebase</h1>

## post__api_firebase_delete_{deviceid}

> Code samples

```http
POST /api/firebase/delete/{deviceid} HTTP/1.1

Accept: application/json

```

`POST /api/firebase/delete/{deviceid}`

*刪除裝置*

根據 deviceID 刪除 Firebase 註冊資訊

<h3 id="post__api_firebase_delete_{deviceid}-parameters">Parameters</h3>
...
<h3 id="post__api_firebase_delete_{deviceid}-responses">Responses</h3>
...
## post__api_firebase_updateLanguage

> Code samples

```http
POST /api/firebase/updateLanguage HTTP/1.1
...
`POST /api/firebase/updateLanguage`
...
<h3 id="post__api_firebase_updatelanguage-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|DeviceID 與 language|
...
<h3 id="post__api_firebase_updatelanguage-responses">Responses</h3>
...
## post__api_firebase_upsert

> Code samples

```http
POST /api/firebase/upsert HTTP/1.1
...
`POST /api/firebase/upsert`

*新增或更新 FCM Device*

將 deviceID 與 token 上傳到 Firebase，若已存在則更新
...
<h3 id="post__api_firebase_upsert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.FCMDeviceProjects](#schemamodel.fcmdeviceprojects)|true|Device 訊息|
...
<h3 id="post__api_firebase_upsert-responses">Responses</h3>
