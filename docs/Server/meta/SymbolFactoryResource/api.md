...
<h1 id="metadata-service-api-symbolfactoryresource">SymbolFactoryResource</h1>

## post__api_symbol_reload

> Code samples

```http
POST /api/symbol/reload HTTP/1.1

Accept: application/json

```

`POST /api/symbol/reload`

*Reload Symbol Factory Resources*

Deletes all existing symbol factory resources and reloads them from files
...
<h3 id="post__api_symbol_reload-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Reload result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
