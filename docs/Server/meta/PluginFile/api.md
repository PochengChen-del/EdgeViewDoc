...
<h1 id="metadata-service-api-pluginfile">PluginFile</h1>

## post__api_pluginfile_delete

> Code samples

```http
POST /api/pluginfile/delete HTTP/1.1
...
`POST /api/pluginfile/delete`

*Delete plugin files*

Delete plugin files by a list of IDs
...
<h3 id="post__api_pluginfile_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|array[integer]|true|List of plugin file IDs to delete|
...
<h3 id="post__api_pluginfile_delete-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Deletion result|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_pluginfile_list_{projid}

> Code samples

```http
POST /api/pluginfile/list/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/pluginfile/list/{projid}`

*List all plugin files for a project*

Get all plugin files associated with the given project ID

<h3 id="post__api_pluginfile_list_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_pluginfile_list_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of plugin files|[model.BaseResponse-array_model_PluginFileDrift](#schemamodel.baseresponse-array_model_pluginfiledrift)|
...
## post__api_pluginfile_list_{projid}_{type}

> Code samples

```http
POST /api/pluginfile/list/{projid}/{type} HTTP/1.1

Accept: application/json

```

`POST /api/pluginfile/list/{projid}/{type}`

*List plugin files by type for a project*

Get plugin files of a specific type for the given project ID

<h3 id="post__api_pluginfile_list_{projid}_{type}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|type|path|integer|true|File type|
...
<h3 id="post__api_pluginfile_list_{projid}_{type}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of plugin files by type|[model.BaseResponse-array_model_PluginFileDrift](#schemamodel.baseresponse-array_model_pluginfiledrift)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID or type|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_pluginfile_upload_{projid}

> Code samples

```http
POST /api/pluginfile/upload/{projid} HTTP/1.1
...
`POST /api/pluginfile/upload/{projid}`

*Upload a plugin file*

Upload a new plugin file to a project
...
<h3 id="post__api_pluginfile_upload_{projid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|body|body|object|true|none|
|» files|body|string(binary)|true|Plugin file to upload|
|» type|body|integer|true|File type (e.g., image)|
|» name|body|string|true|File name|
...
<h3 id="post__api_pluginfile_upload_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Uploaded file information|[model.BaseResponse-model_PluginFileDrift](#schemamodel.baseresponse-model_pluginfiledrift)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid input|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## get__getpluginfile_{projid}_{filename}

> Code samples

```http
GET /getpluginfile/{projid}/{filename} HTTP/1.1

Accept: application/octet-stream

```

`GET /getpluginfile/{projid}/{filename}`

*Download a plugin file*

Get the content of a plugin file by project ID and filename

<h3 id="get__getpluginfile_{projid}_{filename}-parameters">Parameters</h3>
...
<h3 id="get__getpluginfile_{projid}_{filename}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Plugin file content|string|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID or filename|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Internal server error|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
