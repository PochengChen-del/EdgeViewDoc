...
<h1 id="metadata-service-api-audio">Audio</h1>

## post__api_deleteaudio

> Code samples

```http
POST /api/deleteaudio HTTP/1.1
...
`POST /api/deleteaudio`

*Delete audio files*

Delete one or more audio files by their IDs
...
<h3 id="post__api_deleteaudio-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DeleteAudioReq](#schemamodel.deleteaudioreq)|true|Audio IDs to delete|
...
<h3 id="post__api_deleteaudio-responses">Responses</h3>
...
## post__api_getaudiolist_{displayid}

> Code samples

```http
POST /api/getaudiolist/{displayid} HTTP/1.1

Accept: application/json

```

`POST /api/getaudiolist/{displayid}`

*Get audio list by display*

Get list of audio files associated with a specific display ID

<h3 id="post__api_getaudiolist_{displayid}-parameters">Parameters</h3>
...
<h3 id="post__api_getaudiolist_{displayid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Audio list|[model.BaseResponse-array_model_AudioListObj](#schemamodel.baseresponse-array_model_audiolistobj)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid display ID|[model.BaseResponse-array_model_AudioListObj](#schemamodel.baseresponse-array_model_audiolistobj)|
...
## post__api_getprojectaudiolist_{projectid}

> Code samples

```http
POST /api/getprojectaudiolist/{projectid} HTTP/1.1

Accept: application/json

```

`POST /api/getprojectaudiolist/{projectid}`

*Get project audio list*

Get all audio files for a specific project

<h3 id="post__api_getprojectaudiolist_{projectid}-parameters">Parameters</h3>
...
<h3 id="post__api_getprojectaudiolist_{projectid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Project audio list|[model.BaseResponse-array_model_AudioListObj](#schemamodel.baseresponse-array_model_audiolistobj)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID|[model.BaseResponse-array_model_AudioListObj](#schemamodel.baseresponse-array_model_audiolistobj)|
...
Generate audio from text using a specified TTS model
...
<h3 id="post__api_ttsaudio-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.TtsAudio](#schemamodel.ttsaudio)|true|TTS request|
...
<h3 id="post__api_ttsaudio-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Generated audio info|[model.BaseResponse-model_UploadAudioRes](#schemamodel.baseresponse-model_uploadaudiores)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request or path not found|[model.BaseResponse-model_UploadAudioRes](#schemamodel.baseresponse-model_uploadaudiores)|
...
## post__api_uploadaudio_{parentpathid}

> Code samples

```http
POST /api/uploadaudio/{parentpathid} HTTP/1.1
...
`POST /api/uploadaudio/{parentpathid}`

*Upload audio file*

Upload audio file to a specific parent path
...
<h3 id="post__api_uploadaudio_{parentpathid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|parentpathid|path|integer|true|Parent path ID|
|body|body|object|true|none|
|» files|body|string(binary)|true|Audio file|
...
<h3 id="post__api_uploadaudio_{parentpathid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Uploaded audio info|[model.BaseResponse-model_UploadAudioRes](#schemamodel.baseresponse-model_uploadaudiores)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request or path not found|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
