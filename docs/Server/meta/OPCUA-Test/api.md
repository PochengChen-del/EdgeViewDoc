...
<h1 id="metadata-service-api-opcua-test">OPCUA-Test</h1>

## post__api_opcua_conn_upserttest

> Code samples

```http
POST /api/opcua/conn/upserttest HTTP/1.1

Accept: application/json

```

`POST /api/opcua/conn/upserttest`

*Upsert test OPC UA data*

Create a test certificate and upsert test data into the database
...
<h3 id="post__api_opcua_conn_upserttest-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Test data upsert success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Failed to upsert test data|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
