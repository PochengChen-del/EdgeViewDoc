...
<h1 id="metadata-service-api-datamodel">DataModel</h1>

## post__api_datamodel_checkimportpw

> Code samples

```http
POST /api/datamodel/checkimportpw HTTP/1.1
...
`POST /api/datamodel/checkimportpw`

*Check import password*

Verify import password for a data model
...
<h3 id="post__api_datamodel_checkimportpw-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataModelStruct](#schemamodel.datamodelstruct)|true|Data model import password request|
...
<h3 id="post__api_datamodel_checkimportpw-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Password correct or not|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_datamodel_checkpw

> Code samples

```http
POST /api/datamodel/checkpw HTTP/1.1
...
`POST /api/datamodel/checkpw`

*Check data model password*

Verify password for a data model
...
<h3 id="post__api_datamodel_checkpw-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataModelStruct](#schemamodel.datamodelstruct)|true|Data model password request|
...
<h3 id="post__api_datamodel_checkpw-responses">Responses</h3>
...
## post__api_datamodel_delete

> Code samples

```http
POST /api/datamodel/delete HTTP/1.1
...
`POST /api/datamodel/delete`

*Delete data model*

Delete a specific data model by ID
...
<h3 id="post__api_datamodel_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataModelID](#schemamodel.datamodelid)|true|Data model ID to delete|
...
<h3 id="post__api_datamodel_delete-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Deleted successfully|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_datamodel_detail

> Code samples

```http
POST /api/datamodel/detail HTTP/1.1
...
`POST /api/datamodel/detail`

*Get data model detail*

Get the details of a specific data model
...
<h3 id="post__api_datamodel_detail-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataModelID](#schemamodel.datamodelid)|true|Data Model ID|
...
<h3 id="post__api_datamodel_detail-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## get__api_datamodel_export_{projid}_{dmid}

> Code samples

```http
GET /api/datamodel/export/{projid}/{dmid} HTTP/1.1

Accept: application/octet-stream

```

`GET /api/datamodel/export/{projid}/{dmid}`

*Export data model*

Export a data model including variables, JS, images, RC maps

<h3 id="get__api_datamodel_export_{projid}_{dmid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|projid|path|integer|true|Project ID|
|dmid|path|string|true|Data Model ID|

> Example responses

> 400 Response

<h3 id="get__api_datamodel_export_{projid}_{dmid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|File download|None|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_datamodel_imagelist

> Code samples

```http
POST /api/datamodel/imagelist HTTP/1.1
...
`POST /api/datamodel/imagelist`

*Get image list for data model*

Get all images under a data model
...
<h3 id="post__api_datamodel_imagelist-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataModeldmID](#schemamodel.datamodeldmid)|true|Data model ID|
...
<h3 id="post__api_datamodel_imagelist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Image list|[model.BaseResponse-array_controller_ImageListObj](#schemamodel.baseresponse-array_controller_imagelistobj)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponse-array_controller_ImageListObj](#schemamodel.baseresponse-array_controller_imagelistobj)|
...
## post__api_datamodel_import

> Code samples

```http
POST /api/datamodel/import HTTP/1.1
...
`POST /api/datamodel/import`

*Import data model*

Import a data model file (.wa) and insert all associated details
...
<h3 id="post__api_datamodel_import-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|none|
|» projid|body|integer|true|Project ID|
|» importpw|body|string|false|Import password|
|» files|body|string(binary)|true|Data model file|
...
<h3 id="post__api_datamodel_import-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Import success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request or password incorrect|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_datamodel_jslist

> Code samples

```http
POST /api/datamodel/jslist HTTP/1.1
...
`POST /api/datamodel/jslist`

*Get JS list for data model*

Get all JS objects under a data model
...
<h3 id="post__api_datamodel_jslist-parameters">Parameters</h3>
...
<h3 id="post__api_datamodel_jslist-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|JS list|[model.BaseResponse-array_model_JSListObject](#schemamodel.baseresponse-array_model_jslistobject)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponse-array_model_JSListObject](#schemamodel.baseresponse-array_model_jslistobject)|
...
## post__api_datamodel_list_{projid}

> Code samples

```http
POST /api/datamodel/list/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/datamodel/list/{projid}`

*Get data model list by project*

Get all data models under a specific project

<h3 id="post__api_datamodel_list_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_datamodel_list_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad Request|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_datamodel_upsert

> Code samples

```http
POST /api/datamodel/upsert HTTP/1.1
...
`POST /api/datamodel/upsert`

*Insert or update data model*

Create or update a data model, supports file upload for thumbnail
...
<h3 id="post__api_datamodel_upsert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|false|none|
|» id|body|string|false|Data model ID (for update)|
|» projid|body|integer|true|Project ID|
|» name|body|string|true|Data model name|
|» content|body|string|true|Data model content|
|» updatepassword|body|boolean|false|Update password flag|
|» updateimportpw|body|boolean|false|Update import password flag|
|» password|body|string|false|Password|
|» importpw|body|string|false|Import password|
|» parentpathid|body|integer|true|Parent path ID|
|» files|body|string(binary)|false|Thumbnail image file|

> Example responses

> Created/Updated data model info
...
<h3 id="post__api_datamodel_upsert-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Created/Updated data model info|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_datamodel_version

> Code samples

```http
POST /api/datamodel/version HTTP/1.1
...
`POST /api/datamodel/version`

*Get data model version*

Get the version of a data model
...
<h3 id="post__api_datamodel_version-parameters">Parameters</h3>
...
<h3 id="post__api_datamodel_version-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Data model version|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_datamodel_versionlist_{projid}

> Code samples

```http
POST /api/datamodel/versionlist/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/datamodel/versionlist/{projid}`

*Get data model version list*

Get all versions of data models in a project

<h3 id="post__api_datamodel_versionlist_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_datamodel_versionlist_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Version list|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid project ID|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_dm_variable_change

> Code samples

```http
POST /api/dm/variable/change HTTP/1.1
...
`POST /api/dm/variable/change`

*Exchange variable order*

Change the order of variables under a data model
...
<h3 id="post__api_dm_variable_change-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DMVariableExchange](#schemamodel.dmvariableexchange)|true|Variable exchange info|
...
<h3 id="post__api_dm_variable_change-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Updated variable list|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__api_dm_variable_delete

> Code samples

```http
POST /api/dm/variable/delete HTTP/1.1
...
`POST /api/dm/variable/delete`

*Delete variable(s)*

Delete variables from a data model
...
<h3 id="post__api_dm_variable_delete-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataModelVariableDelete](#schemamodel.datamodelvariabledelete)|true|Variables to delete|
...
<h3 id="post__api_dm_variable_delete-responses">Responses</h3>
...
## post__api_dm_variable_import

> Code samples

```http
POST /api/dm/variable/import HTTP/1.1
...
`POST /api/dm/variable/import`

*Import variables*

Import multiple variables into a data model
...
<h3 id="post__api_dm_variable_import-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataModelVariImport](#schemamodel.datamodelvariimport)|true|Variables to import|
...
<h3 id="post__api_dm_variable_import-responses">Responses</h3>
...
## post__api_dm_variable_insert

> Code samples

```http
POST /api/dm/variable/insert HTTP/1.1
...
`POST /api/dm/variable/insert`

*Insert variable*

Add a new variable to a data model
...
<h3 id="post__api_dm_variable_insert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataModelVariStruct](#schemamodel.datamodelvaristruct)|true|Variable data|

> Example responses

> Inserted variable version
...
<h3 id="post__api_dm_variable_insert-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Inserted variable version|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_dm_variable_list

> Code samples

```http
POST /api/dm/variable/list HTTP/1.1
...
`POST /api/dm/variable/list`

*Query variables*

Get all variables under a data model
...
<h3 id="post__api_dm_variable_list-parameters">Parameters</h3>
...
<h3 id="post__api_dm_variable_list-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Variable list|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_dm_variable_update

> Code samples

```http
POST /api/dm/variable/update HTTP/1.1
...
<h3 id="post__api_dm_variable_update-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.DataModelVariUpdate](#schemamodel.datamodelvariupdate)|true|Variable update data|

> Example responses

> Updated variable version
...
<h3 id="post__api_dm_variable_update-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Updated variable version|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_rcmap_detail

> Code samples

```http
POST /api/rcmap/detail HTTP/1.1
...
`POST /api/rcmap/detail`

*Query RC map*

Get RC map data under a data model
...
<h3 id="post__api_rcmap_detail-parameters">Parameters</h3>
...
<h3 id="post__api_rcmap_detail-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|RC map data|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponseLoose](#schemamodel.baseresponseloose)|
...
## post__api_rcmap_upsert

> Code samples

```http
POST /api/rcmap/upsert HTTP/1.1
...
`POST /api/rcmap/upsert`

*Upsert RC map*

Insert or update RC map data
...
<h3 id="post__api_rcmap_upsert-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|Map data with dmid|
...
<h3 id="post__api_rcmap_upsert-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Upsert success|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
