...
<h1 id="metadata-service-api-filecache">FileCache</h1>

## post__api_imageCacheMeta_{projid}

> Code samples

```http
POST /api/imageCacheMeta/{projid} HTTP/1.1

Accept: application/json

```

`POST /api/imageCacheMeta/{projid}`

*Get image cache metadata*

Retrieve image cache metadata for a specific project ID

<h3 id="post__api_imagecachemeta_{projid}-parameters">Parameters</h3>
...
<h3 id="post__api_imagecachemeta_{projid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-array_model_FileCacheMeta](#schemamodel.baseresponse-array_model_filecachemeta)|
...
|503|[Service Unavailable](https://tools.ietf.org/html/rfc7231#section-6.6.4)|Project id does not exist|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
