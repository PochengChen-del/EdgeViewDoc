...
<h1 id="metadata-service-api-file">File</h1>

## post__api_uploadfile
...
<h3 id="post__api_uploadfile-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|none|
|» files|body|string(binary)|true|檔案列表|
...
<h3 id="post__api_uploadfile-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|上傳成功|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|上傳失敗|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## post__getdisplay_{action}

> Code samples

```http
POST /getdisplay/{action} HTTP/1.1

Accept: application/json

```

`POST /getdisplay/{action}`

*取得顯示資訊*

根據動作名稱取得顯示資料

<h3 id="post__getdisplay_{action}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|action|path|string|true|動作名稱|
...
<h3 id="post__getdisplay_{action}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|取得成功|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|資料不存在|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## get__getdmtumb_{objprojid}_{dmid}

> Code samples

```http
GET /getdmtumb/{objprojid}/{dmid} HTTP/1.1

Accept: image/png

```

`GET /getdmtumb/{objprojid}/{dmid}`

*取得 DM 縮圖*

根據 objprojid 與 dmid 回傳 DM 縮圖

<h3 id="get__getdmtumb_{objprojid}_{dmid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|objprojid|path|string|true|專案物件ID|
|dmid|path|string|true|DM ID|

> Example responses

> 200 Response

<h3 id="get__getdmtumb_{objprojid}_{dmid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|回傳 DM 縮圖|string|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|DM 縮圖不存在|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
<h3 id="get__getfile-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|回傳檔案|string|

<aside class="success">
This operation does not require authentication
</aside>

## get__getfile_{pathid}_{filename}

> Code samples

```http
GET /getfile/{pathid}/{filename} HTTP/1.1

Accept: application/octet-stream

```

`GET /getfile/{pathid}/{filename}`

*取得檔案*

根據 pathid 與 filename 取得檔案

<h3 id="get__getfile_{pathid}_{filename}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|pathid|path|string|true|路徑ID|
|filename|path|string|true|檔案名稱|

> Example responses

> 200 Response

<h3 id="get__getfile_{pathid}_{filename}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|回傳檔案|string|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|檔案不存在|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## get__gettumb_{objectid}

> Code samples

```http
GET /gettumb/{objectid} HTTP/1.1

Accept: image/png

```

`GET /gettumb/{objectid}`

*取得縮圖*

根據 objectid 回傳縮圖

<h3 id="get__gettumb_{objectid}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|objectid|path|string|true|物件ID|

> Example responses

> 200 Response

<h3 id="get__gettumb_{objectid}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|縮圖|string|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|縮圖不存在|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|

<aside class="success">
This operation does not require authentication
</aside>

## get__gettumb_{objectid}_{type}

> Code samples

```http
GET /gettumb/{objectid}/{type} HTTP/1.1

Accept: image/png

```

`GET /gettumb/{objectid}/{type}`

*取得手機縮圖*

根據 objectid 與 type 回傳手機版縮圖

<h3 id="get__gettumb_{objectid}_{type}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|objectid|path|string|true|物件ID|
|type|path|string|true|縮圖類型|

> Example responses

> 200 Response

<h3 id="get__gettumb_{objectid}_{type}-responses">Responses</h3>
