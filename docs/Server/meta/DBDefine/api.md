...
<h1 id="metadata-service-api-dbdefine">DBDefine</h1>

## post__api_DBDefine_query

> Code samples

```http
POST /api/DBDefine/query HTTP/1.1

Accept: application/json

```

`POST /api/DBDefine/query`

*Get all database definitions*

Retrieve all database definitions
...
<h3 id="post__api_dbdefine_query-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of database definitions|[model.BaseResponse-array_model_DBDefine](#schemamodel.baseresponse-array_model_dbdefine)|

<aside class="success">
This operation does not require authentication
</aside>

## post__api_DBDefine_query_{dbtype}

> Code samples

```http
POST /api/DBDefine/query/{dbtype} HTTP/1.1

Accept: application/json

```

`POST /api/DBDefine/query/{dbtype}`

*Get database definition by type*

Retrieve database definitions filtered by database type

<h3 id="post__api_dbdefine_query_{dbtype}-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|dbtype|path|string|true|Database type|
...
<h3 id="post__api_dbdefine_query_{dbtype}-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|List of database definitions by type|[model.BaseResponse-array_model_DBDefineBody](#schemamodel.baseresponse-array_model_dbdefinebody)|
