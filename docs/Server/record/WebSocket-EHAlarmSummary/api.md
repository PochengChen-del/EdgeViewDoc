...
<h1 id="proxy-service-api-websocket-ehalarmsummary">WebSocket-EHAlarmSummary</h1>

## post__ws_ehalarmsummary_register

> Code samples

```http
POST /ws/ehalarmsummary/register HTTP/1.1
...
`POST /ws/ehalarmsummary/register`

*Register EH alarm summary polling*

Register client to receive EH alarm summary updates via WebSocket
...
<h3 id="post__ws_ehalarmsummary_register-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[wsmodel.EHAlarmSumaryRegister](#schemawsmodel.ehalarmsumaryregister)|true|Register alarm summary request|
...
<h3 id="post__ws_ehalarmsummary_register-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Register success|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[wsmodel.ErrorMessage](#schemawsmodel.errormessage)|
|401|[Unauthorized](https://tools.ietf.org/html/rfc7235#section-3.1)|Unauthorized|[wsmodel.ErrorMessage](#schemawsmodel.errormessage)|

<aside class="success">
This operation does not require authentication
</aside>

## post__ws_ehalarmsummary_unregister

> Code samples

```http
POST /ws/ehalarmsummary/unregister HTTP/1.1
...
`POST /ws/ehalarmsummary/unregister`

*Unregister EH alarm summary polling*

Unregister client from EH alarm summary updates via WebSocket
...
<h3 id="post__ws_ehalarmsummary_unregister-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[wsmodel.EHAlarmSumaryRegister](#schemawsmodel.ehalarmsumaryregister)|true|Unregister alarm summary request|
...
<h3 id="post__ws_ehalarmsummary_unregister-responses">Responses</h3>
