...
<h1 id="proxy-service-api-websocket-login">WebSocket-Login</h1>

## post__ws_login_login

> Code samples

```http
POST /ws/login/login HTTP/1.1
...
Authenticate client via WebSocket using CSRF token
...
<h3 id="post__ws_login_login-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[wsmodel.Login](#schemawsmodel.login)|true|Login request payload|
...
<h3 id="post__ws_login_login-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Login success|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
...
|401|[Unauthorized](https://tools.ietf.org/html/rfc7235#section-3.1)|Unauthorized|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
