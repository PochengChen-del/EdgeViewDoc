...
<h1 id="proxy-service-api-websocket-recorddata">WebSocket-RecordData</h1>

## post__ws_recorddata_gotopage

> Code samples

```http
POST /ws/recorddata/gotopage HTTP/1.1
...
`POST /ws/recorddata/gotopage`

*Go to specific page*

Jump record data to a specific page
...
<h3 id="post__ws_recorddata_gotopage-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[controller.RecordControlPageReceive](#schemacontroller.recordcontrolpagereceive)|true|Page control request|
...
<h3 id="post__ws_recorddata_gotopage-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Page switched|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|

<aside class="success">
This operation does not require authentication
</aside>

## post__ws_recorddata_nextpage

> Code samples

```http
POST /ws/recorddata/nextpage HTTP/1.1
...
`POST /ws/recorddata/nextpage`

*Go to next page*

Switch record data to next page
...
<h3 id="post__ws_recorddata_nextpage-parameters">Parameters</h3>
...
<h3 id="post__ws_recorddata_nextpage-responses">Responses</h3>
...
## post__ws_recorddata_prevpage

> Code samples

```http
POST /ws/recorddata/prevpage HTTP/1.1
...
`POST /ws/recorddata/prevpage`

*Go to previous page*

Switch record data to previous page
...
<h3 id="post__ws_recorddata_prevpage-parameters">Parameters</h3>
...
<h3 id="post__ws_recorddata_prevpage-responses">Responses</h3>
...
## post__ws_recorddata_register

> Code samples

```http
POST /ws/recorddata/register HTTP/1.1
...
`POST /ws/recorddata/register`

*Register record data polling*

Register a client to receive record data updates via WebSocket
...
<h3 id="post__ws_recorddata_register-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[controller.RecordRegisterReceive](#schemacontroller.recordregisterreceive)|true|Register request payload|
...
<h3 id="post__ws_recorddata_register-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Register success response|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
...
## post__ws_recorddata_unregister

> Code samples

```http
POST /ws/recorddata/unregister HTTP/1.1
...
`POST /ws/recorddata/unregister`

*Unregister record data polling*

Unregister a client from record data polling
...
<h3 id="post__ws_recorddata_unregister-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[controller.RecordRegisterReceive](#schemacontroller.recordregisterreceive)|true|Unregister request payload|
...
<h3 id="post__ws_recorddata_unregister-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Unregister success|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
...
## post__ws_recorddata_update

> Code samples

```http
POST /ws/recorddata/update HTTP/1.1
...
`POST /ws/recorddata/update`

*Update record data*

Force update record data for a specific ID
...
<h3 id="post__ws_recorddata_update-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[controller.RecordRegisterReceive](#schemacontroller.recordregisterreceive)|true|Update request payload|
...
<h3 id="post__ws_recorddata_update-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Update success|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid request|[wsmodel.TopicMessage](#schemawsmodel.topicmessage)|
