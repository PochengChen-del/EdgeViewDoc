...
<h1 id="proxy-service-api-record">Record</h1>

## post__record_gotopage

> Code samples

```http
POST /record/gotopage HTTP/1.1
...
`POST /record/gotopage`

*Move record pagination to specified page*
...
<h3 id="post__record_gotopage-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|Record ID and page|
...
<h3 id="post__record_gotopage-responses">Responses</h3>
...
## post__record_nextpage

> Code samples

```http
POST /record/nextpage HTTP/1.1
...
`POST /record/nextpage`

*Move record pagination to next page*
...
<h3 id="post__record_nextpage-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|Record ID|
...
<h3 id="post__record_nextpage-responses">Responses</h3>
...
## post__record_preview

> Code samples

```http
POST /record/preview HTTP/1.1
...
Execute preview query and return result
...
<h3 id="post__record_preview-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecordStruct](#schemamodel.recordstruct)|true|Record query info|
...
<h3 id="post__record_preview-responses">Responses</h3>
...
## post__record_previewhttp

> Code samples

```http
POST /record/previewhttp HTTP/1.1
...
`POST /record/previewhttp`

*Preview HTTP record*

Execute HTTP request defined in record
...
<h3 id="post__record_previewhttp-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecordStruct](#schemamodel.recordstruct)|true|HTTP record info|
...
<h3 id="post__record_previewhttp-responses">Responses</h3>
...
## post__record_previewquery

> Code samples

```http
POST /record/previewquery HTTP/1.1
...
`POST /record/previewquery`

*Preview query string*

Generate SQL or InfluxDB query string without executing
...
<h3 id="post__record_previewquery-parameters">Parameters</h3>
...
<h3 id="post__record_previewquery-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-string](#schemamodel.baseresponse-string)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad Request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__record_prevpage

> Code samples

```http
POST /record/prevpage HTTP/1.1
...
`POST /record/prevpage`

*Move record pagination to previous page*
...
<h3 id="post__record_prevpage-parameters">Parameters</h3>
...
<h3 id="post__record_prevpage-responses">Responses</h3>
...
## post__record_querydatalog

> Code samples

```http
POST /record/querydatalog HTTP/1.1
...
`POST /record/querydatalog`

*Query record datalog*

Query historical record data with time range and interval
...
<h3 id="post__record_querydatalog-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[controller.RecordQueryData](#schemacontroller.recordquerydata)|true|Datalog query parameters|
...
<h3 id="post__record_querydatalog-responses">Responses</h3>
...
## post__record_queryrecord

> Code samples

```http
POST /record/queryrecord HTTP/1.1
...
`POST /record/queryrecord`

*Query record data with cache and polling*

Query record data, supports cache reuse and version checking
...
<h3 id="post__record_queryrecord-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[controller.RecordQueryData](#schemacontroller.recordquerydata)|true|Record query parameters|
...
<h3 id="post__record_queryrecord-responses">Responses</h3>
...
## post__record_runrecordcmd

> Code samples

```http
POST /record/runrecordcmd HTTP/1.1
...
`POST /record/runrecordcmd`

*Execute record command*

Execute SQL, InfluxDB or HTTP command for a function-type record
...
<h3 id="post__record_runrecordcmd-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|Command request|
...
<h3 id="post__record_runrecordcmd-responses">Responses</h3>
...
Get available table or measurement schema for a record source
...
<h3 id="post__record_schema-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[model.RecordStruct](#schemamodel.recordstruct)|true|Record definition|
...
<h3 id="post__record_schema-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-array_service_DatabaseTable](#schemamodel.baseresponse-array_service_databasetable)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad Request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
...
## post__record_tableschema

> Code samples

```http
POST /record/tableschema HTTP/1.1
...
`POST /record/tableschema`

*Query table or measurement schema*

Get column or key schema for table or measurement
...
<h3 id="post__record_tableschema-parameters">Parameters</h3>
...
<h3 id="post__record_tableschema-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[model.BaseResponse-service_DatabaseColumn](#schemamodel.baseresponse-service_databasecolumn)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad Request|[model.BaseResponse-bool](#schemamodel.baseresponse-bool)|
